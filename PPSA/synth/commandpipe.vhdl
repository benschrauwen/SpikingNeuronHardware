...
port (
    ...
    integrate_d : out std_logic := '0';
    decay_d     : out std_logic := '0';
    state_end_d : out std_logic := '0';
    tap_d       : out std_logic_vector(NR_TAPS_BITS-1 downto 0) := (others => '0');
    extend_d    : out std_logic_vector(NR_SYN_MODELS downto 0) := (others => '0')
);
end commandpipe;
